...
### 1. **Figma**
- **설명**: 실시간 협업이 가능한 디자인 도구. UX/UI 디자인 작업에 유용하며, 다양한 플러그인을 통해 생산성을 높일 수 있습니다.
- **링크**: [Figma 바로가기](https://www.figma.com/files/recents-and-sharing/recently-viewed?fuid=1360424695642556752)
...
### 10. **미리캔버스**
- **설명**: 미리캔버스는 다양한 템플릿과 디자인 요소를 제공하는 온라인 디자인 도구로, PPT, 카드 뉴스, 포스터 등 다양한 그래픽 작업을 손쉽게 제작할 수 있습니다. 드래그 앤 드롭 방식의 직관적인 UI를 통해 초보자도 쉽게 사용할 수 있으며, 한국어 기반의 템플릿이 많이 제공됩니다.
- **링크**: [미리캔버스 바로가기](https://www.miricanvas.com/)

### 11. **캔바 (Canva)**
- **설명**: 캔바는 전 세계적으로 인기 있는 온라인 그래픽 디자인 도구로, PPT, 인포그래픽, 소셜 미디어 게시물 등 다양한 디자인 작업을 간편하게 만들 수 있습니다. 무료로 다양한 템플릿과 디자인 요소를 제공하며, 협업 기능을 통해 여러 사람이 함께 작업할 수도 있습니다.
- **링크**: [캔바 바로가기](https://www.canva.com/)

### 12. **Excalidraw**
- **설명**: Excalidraw는 간단한 스케치 및 다이어그램을 제작할 수 있는 웹 기반의 도구입니다. Obsidian의 플러그인으로도 제공되어, 노트와 다이어그램을 결합하여 시각적인 작업을 손쉽게 수행할 수 있습니다.
- **링크**: [Excalidraw 바로가기](https://excalidraw.com/)

### 13. **Haiper.ai**
- **설명**: Haiper.ai는 AI 기반의 자동화 도구로, 다양한 작업을 자동으로 처리할 수 있는 플랫폼입니다. 검색, 데이터 분석, 문서 생성 등 복잡한 업무를 간단하게 처리할 수 있으며, 사용자는 더 적은 시간으로 더 많은 결과를 얻을 수 있습니다. 기업의 업무 효율성을 극대화하는 데 매우 유용한 도구입니다.
- **주요 기능**:
  1. AI 기반 자동화로 복잡한 작업을 단순화.
  2. 문서 생성, 데이터 분석 등의 작업을 손쉽게 처리.
